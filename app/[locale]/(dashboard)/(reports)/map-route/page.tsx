...
const Home = () => {
  ...
  const [trailerType, setTrailerType] = useState('0'); // 0=None
...
const fetchRouteFromHereAPI = async () => {
  ...
  }, [startLocation, endLocation, transportMode, emissionType, co2Class, trailersCount]);
